...
Run all phases (default):
    python tests/regenerate_tor_det_report.py

Skip ingestion (reuse existing CSVs):
    python tests/regenerate_tor_det_report.py --skip-ingest

Skip ingestion and aggregation (reuse existing normalized JSON):
    python tests/regenerate_tor_det_report.py --skip-aggregate
"""
import argparse
import json
import subprocess
