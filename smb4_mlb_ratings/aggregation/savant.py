...
HITTER_TRAIT_METRIC_COLUMNS: dict[str, tuple[tuple[str, ...], bool]] = {
    ...
    "contact_vs_lhp": (("contact_vs_lhp", "contact_vs_lhp_score"), False),
    "contact_vs_rhp": (("contact_vs_rhp", "contact_vs_rhp_score"), False),
    "power_vs_lhp": (("power_vs_lhp", "power_vs_lhp_score"), False),
    "power_vs_rhp": (("power_vs_rhp", "power_vs_rhp_score"), False),
    "contact_vs_lhp_minus_rhp": (("contact_vs_lhp_minus_rhp",), False),
    "power_vs_lhp_minus_rhp": (("power_vs_lhp_minus_rhp",), False),
    "pa_vs_lhp": (("pa_vs_lhp", "pa_vs_left", "pa_lhp"), False),
    "pa_vs_rhp": (("pa_vs_rhp", "pa_vs_right", "pa_rhp"), False),
    "pa_split_imbalance": (("pa_split_imbalance", "split_pa_imbalance", "lhp_rhp_pa_imbalance"), False),
